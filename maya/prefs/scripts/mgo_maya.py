...
class MgoMaya(object):
    ...
    class Import(object):
        ...
        # main import function (importing shaders, textures and geo)
    ...
    # exports geo from Maya to user defined directory
    class GeoExport(object):
        def __init__(self, project, assets_path, send_mode, tex_res, subdivs, is_animated, export_hierarchy, merge_hierarchy):
            ...
            self.export_hierarchy = export_hierarchy
            self.merge_hierarchy = merge_hierarchy
            self.output_paths = []     # this attr will be queried back in the mgo_app.ui.py module
        ...
        # need to clean this up a lot. Unsure which data to include in data dict
        def create_geo_data(self, geo, namespace, groups, filepath, filename, start_frame, end_frame):
            ...
            return data
            """
    # exports cameras as .fbx to user specified dir
    ...
    # exports shaders in .pre format to user specified dir
    ...
    # class for rendering HDRI of 3d scene and exporting the image
